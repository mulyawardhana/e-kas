            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('kas-opname.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <form>
                        <div class="row mb-3">
                                <label for="" class="col-sm-2 col-form-label">Akun Bank</label>
                                <div class="col-sm-10">
                                <input type="text" class="form-control" id="" name="akun_bank_id" value="{{$cashopname->akun}}" readonly >
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="" class="col-sm-2 col-form-label">Tahun & Bulan</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="month_year" name="month_year" value="{{$month_year}}" readonly>
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="bon_sementara" name="bon_sementara" value="{{$kasbon->nominal ?? 0}}"
                                       >
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="bukti_belum_bayar" value="{{$cashopname->nominal ?? 0}}"
                            ...
                            <div class="row mb-3">
                                <label for="" class="col-sm-2 col-form-label">Start Jam</label>
                                <div class="col-sm-4">
                                    <input type="time" class="form-control" id="start_jam" name="start_jam"
                                       >

                                </div>
                                <label for="" class="col-sm-2 col-form-label">End Jam</label>
                                <div class="col-sm-4">
                                    <input type="time" class="form-control" id="end_jam" name="end_jam"
                                       >
